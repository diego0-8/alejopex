...
<body data-user-id="<?php echo $_SESSION['usuario_id'] ?? ''; ?>">
    ...
    incluirNavbarSiNoEsIframe('asesor_gestionar');
    ?>
    ...
    <!-- Comunicación con el padre (layout_asesor.php) -->
    <script>
        // La función llamarDesdeWebRTC() está en asesor-common.js
        
        // Notificar al padre cuando se carga la página (para actualizar título y navbar)
        // La función notificarCambioAccion() está en asesor-common.js
        if (window.parent && window.parent !== window) {
            notificarCambioAccion('asesor_gestionar', 'Gestionar Cliente');
        }
    </script>
